...
def main(halfmap1,halfmap2,fullmap,apix,ThreeDFSC,dthetaInDegrees,histogram,FSCCutoff,ThresholdForSphericity,HighPassFilter,numThresholdsForSphericityCalcs,gpu=False):
        # Part 00
        ...
        threshold_binarize_mrc("Results_" + ThreeDFSC + "/ResEM" + ThreeDFSC + "Out.mrc", "Results_" + ThreeDFSC + "/" + ThreeDFSC + "_Thresholded.mrc", "Results_" + ThreeDFSC + "/" + ThreeDFSC + "_ThresholdedBinarized.mrc", FSCCutoff, ThresholdForSphericity,FourierShellHighPassFilter,apix,gpu=gpu)
        ...
        print ("Sphericity is %0.2f out of 1 at threshold %0.2f. 1 represents a perfect sphere." % (sphericity, ThresholdForSphericity))
        ...
        if numThresholdsForSphericityCalcs > 0:
                ...
                for thresh in thresh_ranges:
                        ...
                        if gpu:
                            ...
                            cuda_functions.threshold_binarize_array_cuda(\
                            threedfsc_array, FSCCutoff, thresh, FourierShellHighPassFilter, apix)
                        else:
                            threedfsc_array_thresholded, threedfsc_array_thresholded_binarized = \
                            threshold_binarize_array(\
                            threedfsc_array, FSCCutoff, thresh, FourierShellHighPassFilter, apix)
